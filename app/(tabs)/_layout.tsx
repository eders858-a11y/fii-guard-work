...
export default function TabLayout() {
  ...
  const buttonColor = settings.cardColor || colors.surface;
  const buttonText = settings.textColor || colors.tint;
  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        <Tabs.Screen name="eventos" options={{ title: "Eventos", tabBarIcon: ({ color }) => <IconSymbol size={26} name="calendar" color={color} /> }} />
      </Tabs>
    </View>
  );
}
